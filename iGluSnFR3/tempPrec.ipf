...
make/o/n=(maxQ) nQevents, tempJitter,vecStren2
nQevents = 0
...
for (i=1;i<maxQ;i+=1)	
	...
	vecStren2[i] = 1/nQEvents[i] * sqrt(sum(tempSinPart)^2 + sum(tempCosPart)^2)
endfor
...
duplicate/o vecStren2, $vecString

killwaves/z vecStren2, tempJitter
end
